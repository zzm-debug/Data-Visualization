...
(function () {
  ...
  function setupPanelInteraction(panelId, svgSelector, title, type) {
    ...
    chartContent.addEventListener('click', function (e) {
      ...
      // ✅ 热力图注释：属于面板内交互控件，禁止触发“点击打开大图”
      // 典型命中：<details class="hm-anno"> / <summary>
      if ((_e$target$closest = (_e$target = e.target).closest) !== null && _e$target$closest !== void 0 && _e$target$closest.call(_e$target, '.hm-anno') || e.target.tagName === 'DETAILS' || e.target.tagName === 'SUMMARY') {
        return;
      }
  ...
  function setupImagePanelInteraction(panelId, imgSelector, title) {
    ...
    chartContent.addEventListener('click', function (e) {
      ...
      if ((_e$target$closest2 = (_e$target2 = e.target).closest) !== null && _e$target$closest2 !== void 0 && _e$target$closest2.call(_e$target2, '.hm-anno') || e.target.tagName === 'DETAILS' || e.target.tagName === 'SUMMARY') {
        return;
      }
...
//# sourceMappingURL=/svg-interaction.4fa096a5.js.map