...
(function () {
  ...
  var init2DHeatmap = function init2DHeatmap() {
    ...
    // ✅ 背景“卡片内衬”（更柔和）
    root.append("rect").attr("x", 10).attr("y", 10).attr("width", containerWidth - 20).attr("height", containerHeight - 20).attr("rx", 14).attr("ry", 14).attr("fill", "rgba(255,255,255,0.22)").attr("stroke", "rgba(36,52,71,0.08)");
    ...
    var axisColor = "rgba(36,52,71,0.55)";
    var gridColor = "rgba(36,52,71,0.08)";
    ...
    // “Morandi cool-warm” 自定义插值
    var morandiCoolWarm = d3.interpolateRgbBasis(["#6E86A6",
    // 蓝灰
    "#C9D6E5",
    // 浅雾蓝
    "#F7F4EC",
    ...
    var colorScale = d3.scaleSequential().domain([vMin, vMax]).interpolator(morandiCoolWarm);
...
//# sourceMappingURL=/heatmap-2D.1bc469ae.js.map