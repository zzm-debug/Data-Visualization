...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"FOvh":[function(require,module,exports) {
...
(function () {
  ...
  function setupPanelInteraction(panelId, svgSelector, title, type) {
    ...
    chartContent.addEventListener('click', function (e) {
      ...
      // ✅ 热力图注释/徽标：属于面板内交互控件，禁止触发“点击打开大图”
      // 典型命中：<details class="hm-anno"> / <summary> / 右上角 .hm-badge
      if ((_e$target$closest = (_e$target = e.target).closest) !== null && _e$target$closest !== void 0 && _e$target$closest.call(_e$target, '.hm-anno') || (_e$target$closest2 = (_e$target2 = e.target).closest) !== null && _e$target$closest2 !== void 0 && _e$target$closest2.call(_e$target2, '.hm-badge') || e.target.tagName === 'DETAILS' || e.target.tagName === 'SUMMARY') {
        return;
      }
  ...
  function setupImagePanelInteraction(panelId, imgSelector, title) {
    ...
    chartContent.addEventListener('click', function (e) {
      ...
      // ✅ 防止未来图片面板也加类似注释控件后误触发打开
      if ((_e$target$closest3 = (_e$target3 = e.target).closest) !== null && _e$target$closest3 !== void 0 && _e$target$closest3.call(_e$target3, '.hm-anno') || (_e$target$closest4 = (_e$target4 = e.target).closest) !== null && _e$target$closest4 !== void 0 && _e$target$closest4.call(_e$target4, '.hm-badge') || e.target.tagName === 'DETAILS' || e.target.tagName === 'SUMMARY') {
        return;
      }
  ...
  function openSvgInNewWindow(svgSelector, title, type) {
    ...
    function proceedWithNewWindow() {
      ...
      // ✅ 热力图图例同理：主页面在 #heatmap-color-legend（不在 SVG 内）
      ...
      var html = createNewWindowHTML(svgString, title, type, mapLegendHTML, d3LocalUrl, heatmapLegendHTML);
  ...
  //#region 新窗口大图模板（SVG 复制 + 交互恢复 + 热力图注释/图例）
...
//# sourceMappingURL=/svg-interaction.7578e76d.js.map