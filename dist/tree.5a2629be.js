...
(function () {
  // Parcel 开发服务器会将所有请求路由到 index.html（SPA 路由）
  // 解决方案：尝试多个路径，包括 public 目录（Parcel 会直接服务 public 目录的文件）
  // 尝试多个可能的文件路径
  var DATA_URLS = ["/assets/music_genres_full_with_scraped_info.json",
  // public 目录（Parcel 直接服务）
  "./assets/music_genres_full_with_scraped_info.json",
  // 相对路径
  "assets/music_genres_full_with_scraped_info.json", "../assets/music_genres_full_with_scraped_info.json"];
  function getSize() {
      ...
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.p = _context2.n) {
          ...
          case 13:
            ...
            console.error("💡 提示：Parcel 开发服务器将所有请求路由到 index.html");
            console.error("💡 解决方案：1) 运行 npm run build 构建项目；2) 或将文件放在 public/ 目录");
            errorMessage = "\u6587\u4EF6\u672A\u627E\u5230: music_genres_full_with_scraped_info.json\n\u5DF2\u5C1D\u8BD5\u8DEF\u5F84: ".concat(DATA_URLS.join(', '), "\n\nParcel \u5F00\u53D1\u670D\u52A1\u5668\u95EE\u9898\uFF1A\u6240\u6709\u8BF7\u6C42\u88AB\u8DEF\u7531\u5230 index.html\n\u89E3\u51B3\u65B9\u6848\uFF1A\u8FD0\u884C npm run build \u6216\u4F7F\u7528\u751F\u4EA7\u7248\u672C");
...
//# sourceMappingURL=/tree.5a2629be.js.map