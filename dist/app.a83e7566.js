...
(function () {
  ...
  function render() {
    ...
    note.append("text").attr("x", 14).attr("y", 19).style("font", "14px system-ui, -apple-system, Segoe UI, Microsoft YaHei, sans-serif").style("fill", "rgba(226, 232, 240, 0.86)").text("气泡=评论数  ｜  外环=互动率（相对进度）");
...
//# sourceMappingURL=/app.a83e7566.js.map