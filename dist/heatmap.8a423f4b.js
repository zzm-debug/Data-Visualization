...
(function () {
  ...
  function init3DHeatmap() {
    ...
    var cyberStops = ["#3a2a6d", accentBlue, accentCyan, "#ff5adf"];
        ...
        if (areaPath && !areaPath.includes('NaN')) {
          ...
          areaElement.on("mousemove", function (event) {
            ...
            if (nearestPoint && minDistance < 100) {
              // 从JSON获取曲目数量
              var trackCount = 0;
              if (genreData && genreData[_monthIdx]) {
                var _chunk = genreData[_monthIdx];
        ...
        if (linePath && !linePath.includes('NaN')) {
          ...
          lineElement.on("mousemove", function (event) {
            ...
            if (nearestPoint && minDistance < 100) {
              ...
              var trackCount = 0;
              if (genreData && genreData[_monthIdx]) {
                var _chunk2 = genreData[_monthIdx];
...
//# sourceMappingURL=/heatmap.8a423f4b.js.map